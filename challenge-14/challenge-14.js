(function() {
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce( function ( amount, item ) {
  ...
  */
  console.log( '\nOperation 2:' );
  var operation2 = justMod2Or3.reduceRight( function( amount, item ) { 
    return (amount + 1) * item;
  }, 0);
  ...
  */
  ...
  var name = [ 'Gre', 'go', 'ry' ]
  var reduceP = name.reduce( function( amount, item ) {
    return amount + 'P' + item;
  }, '');
  console.log( reduceP );
  ...
  */
  console.log( '\nInversed Name:' );
  var inversedName = name.reduceRight( function( amount, item ) {
    return amount + item;
  });
