(function (){
  ...
  */
  ...
  var suldeste = ['Minas Gerais', 'Espirito Santo', 'São Paulo', 'Rio de Janeiro'];
  var norte = ['Acre', 'Amazonas', 'Roraima', 'Amapá', 'Pará'];
  ...
  */
  ...
  var resultEvery = brasil.every( state => {
  ...
  */
  ...
  var resultSome = brasil.some( item => {
    return item === 'Ceará';
  });

  console.log( resultSome  ? 'Ceará está incluído!' : 'Ceará não foi incluído :(');
  ...
  */
  var filter  = newBrazil.filter((item) => {
    return item.id % 2 === 0
  });
